...
<div class="min-h-screen flex justify-center bg-gray-100 p-6 pt-10">
    <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-5xl">
        ...
        <form id="formVenta" method="POST" action="${pageContext.request.contextPath}/ControladorVenta">
            <input type="hidden" name="accion" value="guardar">

            <!-- Cliente y Fecha -->
            <div class="flex justify-between items-end mb-8 gap-6">
                <div class="flex flex-col w-1/2">
                    <label class="font-semibold mb-1 text-gray-700">Cliente</label>
                    <select name="cliente"
                ...
                <div class="flex flex-col">
                    <label class="font-semibold mb-1 text-gray-700">Fecha</label>
            ...
            <div class="overflow-y-auto max-h-[300px] border border-gray-200 rounded-lg">
                <table class="min-w-full text-sm text-gray-700">
                    <thead class="bg-gray-100 uppercase text-xs text-gray-600 sticky top-0">
                        <tr>
...
<div id="modalAgregarLibro"
    ...
    <div class="bg-white p-6 rounded-xl shadow-2xl w-full max-w-md">
        ...
        <label class="font-semibold mt-4 block text-gray-700">Cantidad</label>
        <input type="number" id="addCantidad" required
               class="w-full p-2 border border-gray-300 rounded-md mt-1 focus:outline-none focus:ring-2 focus:ring-blue-500">

        <label class="font-semibold mt-4 block text-gray-700">Precio</label>
        <input type="number" id="addPrecio" required
               class="w-full p-2 border border-gray-300 rounded-md mt-1 focus:outline-none focus:ring-2 focus:ring-blue-500">
